            ...
            <div className='productScreenSection'>
                <div className="productScreenImageDiv">
                    <img className='productScreenImage' src={product.image} alt="" 
                        style={{width: '350px', height: '350px', objectFit: 'fit', objectPosition: 'center'}}
                    />
                </div>
                <div className="productScreenContentDiv">
                    <div className="productScreenContentTextDiv">
                        ...
                        <div className='productScreenPriceDiv'>
                            <p className='productScreenPrice'><span className='productScreenPriceTitle'>Price: </span><span className='productScreenPriceValue'>Rs.</span><span className='productScreenPriceValue'>{product.price}</span></p>
                        </div>
